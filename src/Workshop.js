        ...
        <div>
            <div className=" bg-white py-20 px-10">
                <div className="max-w-5xl m-auto">
                    ...
                    <p className="text-black mb-5 body-text-2">In a few days we'll add projects of the workshop and different projects that have been created, but for now enjoy this random pic of a doughnut 🍩</p>
